/*Caso queira deixar o codigo mais bonito, ficarei agradecido
 * Tem algumas coisas para deixar ele melhor tbm em questao de codigo
 * Caso tenha interesse em mexer em algo, fique a disposição
 */
...
class api {
    void newApi (String[] args) throws InterruptedException {
        ...
        int button, botao, quantidade, dados; // --> Decisão do codigo.
        int choose = 0;
        String Address;
...
System.out.println("Deseja alterar algum dos dados cadastrais? ");
System.out.println("Insira o numero 1 para - Alterar o seu login de acesso.");
System.out.println("Insira o numero 2 para - Alterar a sua senha de acesso.");
System.out.println("Insira o numero 3 para - Alterar o seu endereço de envio das doações.");
dados = input.nextInt();

if (dados == 1) {
      System.out.println("Insira o seu novo login de acesso: ");
      Cadastro[2] = input.next();
      Thread.sleep(2000);
      System.out.println("Login alterado com sucesso. Faça o login novamente para confirmar.");
      do{
        System.out.println("Insira o seu login de entrada: ");
        Login [0] = input.next();
...
if (dados == 2){
    System.out.println("Insira a sua nova senha de acesso: ");
    Cadastro[3] = input.next();
    Thread.sleep(2000);
    System.out.println("Senha alterado com sucesso. Faça o login novamente para confirmar.");
    do{
        System.out.println("Insira o seu login de entrada: ");
        Login [0] = input.next();
...
if(dados == 3){
    input.nextLine();
    System.out.println("Insira o seu novo endereço: ");
    Cadastro[4] = input.nextLine();
    Thread.sleep(2000);
    System.out.println("Endereço alterado com sucesso. Enviaremos as doações para o seu novo endereço: " + Cadastro[4]);
}
